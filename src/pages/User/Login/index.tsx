...
import {REGISTER_LINK, SYSTEM_LOGO} from "@/constants";
...
const Login: React.FC = () => {
  ...
  const handleSubmit = async (values: API.LoginParams) => {
    try {
      ...
      console.log(user);
      // 如果失败去设置用户错误信息
      throw new Error(`loginError error id = ${loginResult.data.id}`);
    } catch (error) {
    ...
    <div className={containerClassName}>
      ...
      >
        <LoginForm
          ...
          subTitle={
            <>
              <a href={REGISTER_LINK} target={"_parent"} rel={"noreferrer"} style={{color:"blue",textDecoration:"none"}}>
                加入我们~
              </a>
            </>
          }
